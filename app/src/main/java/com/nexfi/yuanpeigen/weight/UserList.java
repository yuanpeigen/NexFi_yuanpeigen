...
public class UserList extends BaseExpandableListAdapter {
    ...
    private List<ChatUser> userinfosNew;
    private List<String> groupList;
    private List<ChatUser> userinfosOnline;
    private List<ChatUser> userinfosOffilne;
    private List<List<ChatUser>> childListNew;
    private List<List<ChatUser>> childListOnline;
    private List<List<ChatUser>> childListOffline;

    public UserList(Context context, List<ChatUser> userinfosNew, List<ChatUser> userinfosOnline, List<ChatUser> userinfosOffilne, List<String> groupList, List<List<ChatUser>> childListNew, List<List<ChatUser>> childListOnline, List<List<ChatUser>> childListOffline) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        if (groupPosition == 2) {
            final ChatUser entity = userinfosNew.get(childPosition);
            ...
            final ChatUser entity = userinfosOnline.get(childPosition);
            ViewHolder holder = null;
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.new_child, null);
                holder = new ViewHolder();
            ...
            final ChatUser entity = userinfosOffilne.get(childPosition);
            ViewHolder holder = null;
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.new_child, null);
                holder = new ViewHolder();
